...
import type { CameraApiItem, CityDto, NeighborhoodDto } from '@/types/camera/camera'
import type { CameraCreateStep, MapCoordinates } from '@/types/camera/cameraCreate'
import { parseApiError } from '@/utils/apiError'
import CameraCreateActions from '@/components/camera/create/CameraCreateActions.vue'
import CameraCreateProgress from '@/components/camera/create/CameraCreateProgress.vue'
import CameraCreateSuccess from '@/components/camera/create/CameraCreateSuccess.vue'
import CameraDataStep from '@/components/camera/create/CameraDataStep.vue'
import CameraLocationStep from '@/components/camera/create/CameraLocationStep.vue'
import CameraReviewStep from '@/components/camera/create/CameraReviewStep.vue'
import { useAddressAutocomplete } from '@/composables/camera/useAddressAutocomplete'
import { useCameraCreateForm } from '@/composables/camera/useCameraCreateForm'
import { useCameraTerritory } from '@/composables/camera/useCameraTerritory'
import { useUnsavedCameraGuard } from '@/composables/camera/useUnsavedCameraGuard'
