...
<template>
  <div class="fixed inset-0 z-20 flex items-center justify-center bg-black/80">
    <div
      class="flex max-h-[90vh] w-[90%] max-w-md flex-col overflow-y-auto rounded-2xl bg-white pt-4 pb-7 shadow-lg dark:bg-[#000d19]"
    >
