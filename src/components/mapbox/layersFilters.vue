...
<template>
  <div
    class="absolute md:right-2 top-20 md:top-auto right-5 md:bottom-5 rounded-2xl bg-white p-5 text-center dark:bg-[#001C3B] overflow-hidden transition-all duration-300"
  >
